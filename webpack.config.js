...
// primary config:
const title = 'Simulador de Bitcoin';
...
module.exports = ({ production, server, extractCss, coverage, analyze, karma } = {}) => ({
  resolve: {
    ...
    alias: {
      ...
      'sha256': path.resolve(__dirname, 'node_modules/js-sha256/build/sha256.min.js')
    }
  },
  entry: {
    app: ['aurelia-bootstrapper', './external/bulma/bulma.sass']
  },
  ...
  module: {
    rules: [
      ...
      {
        test: path.resolve('./external/bulma/bulma.sass'),
        use: [{
          loader: 'file-loader',
          options: {
            name: 'styles.css'
      ...
      { test: /\.(ttf|eot|svg|otf)(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'file-loader', options: { outputPath: '/' } }
